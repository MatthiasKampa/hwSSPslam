...
Usage:
  python3 ssp_scale_arrays.py selftest
  python3 ssp_scale_arrays.py cell <world> <seed> [nogate|recent]
  python3 ssp_scale_arrays.py bench [quick]        # paired vs G1 + HY4
  python3 ssp_scale_arrays.py carmen [path]        # mirrors ssp_bounded_carmen
"""
...
def run_cell(gran, world, seed, n=750):
    if gran == "G1":
        ...
        import ssp_hier as H                # run only, never edited
