...
Fairness rules shared with the other baselines (see sspslam/frontend.py):
...
- Loop closures: for keyframes > 300 kf past a submap and within 5 m of it,
  ...
  sspslam/bounded.py, Huber-robustified).

Usage: python3 -m baselines.csm [data/intel.log] [n_keyframes]
"""
...
from sspslam.frontend import (parse_flaser, keyframes, compose_guess,
                             align_se2, VALID_MAX)
from sspslam.lattice import se2_mul, se2_inv
