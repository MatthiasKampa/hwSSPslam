...
Usage:
  python3 -m baselines.scancontext            # MIT + Intel recall tables + verdict
  python3 -m baselines.scancontext mit
  python3 -m baselines.scancontext intel
  python3 -m baselines.scancontext selftest
"""
...
import sspslam.frontend as C  # parse_flaser, keyframes (reused, not modified)
