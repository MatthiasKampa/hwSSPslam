...
Usage:
  python3 ssp_seqslam.py selftest
  python3 ssp_seqslam.py mit   [data/mit.log]     # separation + ATE, all systems
  python3 ssp_seqslam.py intel [data/intel.log]   # sanity: must not regress
"""
...
class SeqSLAM(RK.RingKeySLAM):
    ...
    def _try_drought(self, pts, w):
        ...
        # add_keyframe (ssp_hier.py:828), BEFORE our add_keyframe wrapper stores
    ...
    def _insert_edges(self, clique):
        ...
        HybridSLAM._try_drought (ssp_hier.py ~1454-1476)."""
        tail = clique[-1]
