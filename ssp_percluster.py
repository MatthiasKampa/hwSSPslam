...
Usage:
  python3 ssp_percluster.py selftest
  python3 ssp_percluster.py capacity [intel|mit]
  python3 ssp_percluster.py closure  [intel|mit]
  python3 ssp_percluster.py frontend [fr101|fr079|intel]
  python3 ssp_percluster.py all
"""
...
from ssp_ringkey import grid_from_pts
