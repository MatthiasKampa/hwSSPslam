...
Entry points:
  python3 ssp_frontguard.py selftest        # fast determinism / identity check
  python3 ssp_frontguard.py diag            # per-frame c01/coh_ref & |corr| dists
  python3 ssp_frontguard.py sweep           # full 5-log rule/param sweep + verdict
  python3 ssp_frontguard.py run <log> <rule> [k=v ...]
"""
import sys
import time
