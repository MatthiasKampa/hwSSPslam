...
Usage:
  python3 ssp_belief.py selftest
  python3 ssp_belief.py bench [quick]          (corridor/sparse/room, paired)
  python3 ssp_belief.py carmen <log> [n] [--base] [--suppress]
"""
...
# ---------------------------------------------------------------------------
# CARMEN driver (mirrors ssp_bounded_carmen.py; odometry is the belief prior)
# ---------------------------------------------------------------------------
