...
works GIVEN correspondences..."). ssp_multisession_align.py was a FALSE WIN: its
...
Usage:
    python3 ssp_multisession_ringkey.py selftest   # fast retrieval/seed checks
    python3 ssp_multisession_ringkey.py run        # full experiment (auto-builds)
"""
