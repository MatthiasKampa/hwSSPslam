...
Usage:
  python3 -m experiments.adaptmap probe   [log]        # similarity distribution
  python3 -m experiments.adaptmap sweep   [log]        # tau sweep, one log
  python3 -m experiments.adaptmap all                  # full table, all four logs
  python3 -m experiments.adaptmap selftest             # invariants
"""
