...
Usage:
    python3 -m experiments.flow selftest          # gradient FD checks + sanity
    python3 -m experiments.flow single intel      # test 1 (also fr079, fr101)
    python3 -m experiments.flow mit                # test 2 (graceful degradation)
    python3 -m experiments.flow multi             # test 3 (multi-session convergence)
"""
...
from sspslam.bounded import BoundedSLAM, ANCHOR
