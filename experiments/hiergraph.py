...
Run:
  python3 -m experiments.hiergraph selftest
  python3 -m experiments.hiergraph log data/intel.log flat
  python3 -m experiments.hiergraph log data/intel.log hier 6
  python3 -m experiments.hiergraph sweep data/fr079.log 2 4 6 8 12
"""
...
# --------------------------------------------------------------------------
# Real-log harness (mirrors runners/carmen.py exactly; zero new tuning)
# --------------------------------------------------------------------------
