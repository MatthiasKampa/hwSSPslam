...
Usage:
  python3 -m experiments.posefilter selftest
  python3 -m experiments.posefilter bench [quick]        (corridor/room/sparse, paired)
  python3 -m experiments.posefilter carmen <log> [n] [--base]
"""
...
# ---------------------------------------------------------------------------
# CARMEN driver (mirrors runners/carmen.py)
# ---------------------------------------------------------------------------
