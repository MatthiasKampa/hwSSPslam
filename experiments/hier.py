...
Usage:
  python3 -m experiments.hier selftest
  python3 -m experiments.hier cell <gran> <world> <seed> [beta]          # one json row
      gran: G1|G2|G3|G6 | HY|HY-spin|HY-noirls | HY4|HY4-spin|HY4-noirls
  python3 -m experiments.hier bench [quick]                              # R1 sweep
  python3 -m experiments.hier intel [data/intel.log] [gran] [beta]       # R1 CARMEN
  python3 -m experiments.hier hyintel [log] [spin] [noirls] [s2] [nodrought]  # R2/R3
  python3 -m experiments.hier drought [seeds...]                         # R3 bench
"""
...
def main_carmen_hybrid(argv):
    """R2 CARMEN entry: mirrors main_carmen / runners/carmen.py exactly
