...
experiments/multisession.py proved the VSA composition half (bundling = addition merges
...
Usage:
    python3 -m experiments.multisession_align selftest   # fast graph-algebra checks
    python3 -m experiments.multisession_align build       # build+cache the rich sessions
    python3 -m experiments.multisession_align run         # full experiment (auto-builds)
"""
...
from experiments.multisession import (place, se2, se2i, gt_dense, make_matcher,
