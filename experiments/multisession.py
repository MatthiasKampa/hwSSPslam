...
Usage:
    python3 -m experiments.multisession selftest         # fast algebra checks
    python3 -m experiments.multisession build            # build+cache the two sessions
    python3 -m experiments.multisession run              # full experiment (auto-builds)
"""
