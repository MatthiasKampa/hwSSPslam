...
cross-session candidates on Intel (experiments/multisession_ringkey.py: recall@40
...
Usage:
    python3 -m experiments.multisession_verify selftest   # fast checks
    python3 -m experiments.multisession_verify run        # full capstone experiment
"""
...
from experiments.hier import HybridSLAM
...
import experiments.multisession_ringkey as RK
from experiments.multisession_ringkey import (
