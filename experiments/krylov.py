...
Usage:
  python3 -m experiments.krylov selftest                # CG check + bit-exact proof
  python3 -m experiments.krylov screen                  # fr101[:1200] grid sweep
  python3 -m experiments.krylov run fr101 2 10          # full log at (n_outer,n_inner)
  python3 -m experiments.krylov band fr079 2 10         # eps-ladder perturbation band
"""
import sys
import time
