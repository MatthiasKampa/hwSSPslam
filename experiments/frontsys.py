...
Entry points:
  python3 -m experiments.frontsys selftest     # determinism / identity == shipped
  python3 -m experiments.frontsys diag         # rho distributions, all logs/W/frames
  python3 -m experiments.frontsys sweep        # guard (lo,hi,W) sweep + do-no-harm verdict
  python3 -m experiments.frontsys run <log> <rule> [k=v ...]
"""
import sys
import time
...
import experiments.frontguard as FG   # reuse eval harness (LOGS, _eval_*, VALID_MAX)
