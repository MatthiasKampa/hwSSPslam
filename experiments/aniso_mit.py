...
"the wall is TWO-FOLD"). The isotropic GT-oracle (experiments/mit_gtverify.py) found:
...
Usage: python3 -m experiments.aniso_mit [data/mit.log] [oracleA|oracleB|both]
"""
...
import experiments.mit_gtverify as GTV
import experiments.aniso as A
...
class AnisoGTVerifySLAM(A.AnisoMixin, GTV.GTVerifySLAM):
    ...
    def _try_drought(self, pts, w):
        ...
        if old.size == 0:
            return
        from experiments.ringkey import grid_from_pts, TOP_K
