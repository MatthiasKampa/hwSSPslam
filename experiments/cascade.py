...
the shipped ring-major polar lattice (sspslam/lattice.py: rings lam
...
Run:  python3 -m experiments.cascade [selftest|roc|intel|all]
"""
...
import sspslam.worlds as worlds
