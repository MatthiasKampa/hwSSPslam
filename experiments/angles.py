...
Usage:
  python3 -m experiments.angles selftest
  python3 -m experiments.angles intel [data/intel.log]      # all 4 configs
  python3 -m experiments.angles bench                        # room/sparse/corridor
  python3 -m experiments.angles fr079 [data/fr079.log]       # top-2 configs
"""
