...
Usage:
  python3 -m sspslam.quantized selftest              # neutralised == parent, quick
  python3 -m sspslam.quantized sweep intel fr101     # write-time ladder on given logs
  python3 -m sspslam.quantized ops                   # op/memory sizing report
"""
import sys
import time
