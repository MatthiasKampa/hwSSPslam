...
Usage:
  python3 -m sspslam.worlds_dyn check     # geometry, clearance, determinism, pairing
  python3 -m sspslam.worlds_dyn quick     # classroom +-people, 360 beams (fast)
  python3 -m sspslam.worlds_dyn bench     # full grid, 1024 beams, bridge2 sampler
  python3 -m sspslam.worlds_dyn tenx      # school10x map-size pressure (iCE40 SPRAM)
"""
import sys
...
from sspslam.worlds import _rect
