...
The GT-verify diagnostic (ssp_mit_gtverify.py; RESULTS.md "the wall is TWO-FOLD")
...
Usage:
  python3 ssp_aniso.py selftest
  python3 ssp_aniso.py logs [floor ...]      # real-log ATE sweep vs shipped
  python3 ssp_aniso.py mit [data/mit.log]    # GT-oracle MIT (anisotropic drought)
"""
