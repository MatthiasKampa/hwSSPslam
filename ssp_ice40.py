...
model BIT-EXACTLY (golden vectors: ice40/host/vectors.py). Float encode is
...
Usage:
  python3 ssp_ice40.py selftest       # LUT sanity + fidelity vs float encode
  python3 ssp_ice40.py fidelity       # per-scan cosine on spot + synth data
"""
import sys
