// tb_solo_top2.v — GATE COPY of the untouched ice40 tb_solo_top.v
// with the dut swapped to top_solo2 (v8 novelty folding). The
// hierarchical debug peeks (dut.kst, dut.trk.tst, RAM images)
// resolve because top_solo2 keeps v7's internal names.
...
module tb;
    ...
    top_solo2 #(.UDIV(UDIV), .REFINE(0)) dut (.clk(clk), .RX(rx_line),
                                             .TX(tx_line),
                                             .LEDR_N(), .LEDG_N());
