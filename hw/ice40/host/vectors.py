...
"""Golden-vector harness: golden model (ssp_ice40) vs simulation vs hardware.
  ...
  python3 hw/ice40/host/vectors.py gen [n]     # build/points.hex + golden
  python3 hw/ice40/host/vectors.py sim         # iverilog run, bit-exact compare
  python3 hw/ice40/host/vectors.py hw [port]   # board run, bit-exact compare
  python3 hw/ice40/host/vectors.py hw-scan     # full real SPOT scan on hw
"""
import glob
import subprocess
import sys
