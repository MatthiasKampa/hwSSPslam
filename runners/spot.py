...
Usage:
  python3 -m runners.spot parse          # build the npz cache from parquet
  python3 -m runners.spot sweep          # settings sweep (lidar-only, GT=odom)
"""
import sys
...
DIR = Path(__file__).resolve().parents[1] / "data" / "spot_telluride"
